...
static char aruco_msgs__msg__Marker__FIELD_NAME__header[] = "header";
static char aruco_msgs__msg__Marker__FIELD_NAME__id[] = "id";
static char aruco_msgs__msg__Marker__FIELD_NAME__pose[] = "pose";
static char aruco_msgs__msg__Marker__FIELD_NAME__confidence[] = "confidence";

static rosidl_runtime_c__type_description__Field aruco_msgs__msg__Marker__FIELDS[] = {
  {
    {aruco_msgs__msg__Marker__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {aruco_msgs__msg__Marker__FIELD_NAME__id, 2, 2},
    {
  ...
  {
    {aruco_msgs__msg__Marker__FIELD_NAME__pose, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {aruco_msgs__msg__Marker__FIELD_NAME__confidence, 10, 10},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription aruco_msgs__msg__Marker__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {aruco_msgs__msg__Marker__FIELDS, 4, 4},
    },
    {aruco_msgs__msg__Marker__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
aruco_msgs__msg__Marker__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *aruco_msgs__msg__Marker__get_individual_type_description_source(NULL),
