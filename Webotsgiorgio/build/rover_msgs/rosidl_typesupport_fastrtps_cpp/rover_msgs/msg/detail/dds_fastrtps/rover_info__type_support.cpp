...
#include "rover_msgs/msg/detail/rover_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rover_msgs::msg::RoverInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rover_msgs::msg::RoverInfo & ros_message)
{
  // Member: footprint
  {
    cdr >> ros_message.footprint;
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 6;
    size_t item_size = sizeof(ros_message.footprint[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rover_msgs::msg::RoverInfo;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rover_msgs
max_serialized_size_key_RoverInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const rover_msgs::msg::RoverInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rover_msgs::msg::RoverInfo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RoverInfo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rover_msgs::msg::RoverInfo *>(
...
static size_t _RoverInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RoverInfo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RoverInfo__callbacks = {
  "rover_msgs::msg",
  "RoverInfo",
...
static rosidl_message_type_support_t _RoverInfo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RoverInfo__callbacks,
...
{
  return &rover_msgs::msg::typesupport_fastrtps_cpp::_RoverInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rover_msgs, msg, RoverInfo)() {
  return &rover_msgs::msg::typesupport_fastrtps_cpp::_RoverInfo__handle;
}
