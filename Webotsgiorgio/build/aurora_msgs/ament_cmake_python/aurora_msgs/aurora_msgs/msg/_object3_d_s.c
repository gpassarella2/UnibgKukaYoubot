...
bool aurora_msgs__msg__object3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aurora_msgs.msg._object3_d.Object3D", full_classname_dest, 35) == 0);
  }
  aurora_msgs__msg__Object3D * ros_message = _ros_message;
  {  // header
...
PyObject * aurora_msgs__msg__object3_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aurora_msgs.msg._object3_d");
