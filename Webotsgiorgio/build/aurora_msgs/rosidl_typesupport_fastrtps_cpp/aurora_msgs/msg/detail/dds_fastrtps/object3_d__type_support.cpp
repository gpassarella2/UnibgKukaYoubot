...
#include "aurora_msgs/msg/detail/object3_d__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aurora_msgs::msg::Object3D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aurora_msgs::msg::Object3D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aurora_msgs::msg::Object3D *>(
    untyped_ros_message);
...
{
  return &aurora_msgs::msg::typesupport_fastrtps_cpp::_Object3D__handle;
}
