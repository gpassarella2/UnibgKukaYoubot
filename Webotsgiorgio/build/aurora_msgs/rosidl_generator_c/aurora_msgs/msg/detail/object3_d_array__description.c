  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xbc, 0xa0, 0x6b, 0x95, 0xb3, 0x36, 0xfb, 0x47,
      0x68, 0xf2, 0xb3, 0x6e, 0x04, 0xfd, 0xed, 0x6c,
      0xb2, 0xec, 0xb7, 0x6b, 0x54, 0x7a, 0xc1, 0x27,
      0xc3, 0xe2, 0xb5, 0xf6, 0x1d, 0x8e, 0xd3, 0x6d,
    }};
  return &hash;
}
...
#ifndef NDEBUG
static const rosidl_type_hash_t aurora_msgs__msg__Object3D__EXPECTED_HASH = {1, {
    0x55, 0xdc, 0xdd, 0x41, 0xa6, 0x92, 0x7b, 0xc1,
    0x64, 0x56, 0xf8, 0x71, 0xd7, 0xb0, 0xb4, 0xcc,
    0xdf, 0xdc, 0xae, 0x76, 0xf1, 0x60, 0x3d, 0xa5,
    0xdb, 0x5e, 0xfe, 0x09, 0x85, 0x1b, 0x81, 0xef,
  }};
...
static char aurora_msgs__msg__Object3DArray__TYPE_NAME[] = "aurora_msgs/msg/Object3DArray";
static char aurora_msgs__msg__Object3D__TYPE_NAME[] = "aurora_msgs/msg/Object3D";
...
static char aurora_msgs__msg__Object3DArray__FIELD_NAME__header[] = "header";
static char aurora_msgs__msg__Object3DArray__FIELD_NAME__objects[] = "objects";

static rosidl_runtime_c__type_description__Field aurora_msgs__msg__Object3DArray__FIELDS[] = {
  {
    {aurora_msgs__msg__Object3DArray__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {aurora_msgs__msg__Object3DArray__FIELD_NAME__objects, 7, 7},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
      {aurora_msgs__msg__Object3D__TYPE_NAME, 24, 24},
    },
    {NULL, 0, 0},
  },
};

static rosidl_runtime_c__type_description__IndividualTypeDescription aurora_msgs__msg__Object3DArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {aurora_msgs__msg__Object3D__TYPE_NAME, 24, 24},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {aurora_msgs__msg__Object3DArray__TYPE_NAME, 29, 29},
      {aurora_msgs__msg__Object3DArray__FIELDS, 2, 2},
    },
    {aurora_msgs__msg__Object3DArray__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
    assert(0 == memcmp(&aurora_msgs__msg__Object3D__EXPECTED_HASH, aurora_msgs__msg__Object3D__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[0].fields = aurora_msgs__msg__Object3D__get_type_description(NULL)->type_description.fields;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *aurora_msgs__msg__Object3DArray__get_individual_type_description_source(NULL),
    sources[1] = *aurora_msgs__msg__Object3D__get_individual_type_description_source(NULL);
