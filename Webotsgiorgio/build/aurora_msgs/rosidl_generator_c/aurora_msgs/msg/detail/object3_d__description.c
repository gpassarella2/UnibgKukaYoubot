...
static char aurora_msgs__msg__Object3D__FIELD_NAME__header[] = "header";
static char aurora_msgs__msg__Object3D__FIELD_NAME__id[] = "id";
static char aurora_msgs__msg__Object3D__FIELD_NAME__type[] = "type";
static char aurora_msgs__msg__Object3D__FIELD_NAME__size[] = "size";
static char aurora_msgs__msg__Object3D__FIELD_NAME__pose[] = "pose";
static char aurora_msgs__msg__Object3D__FIELD_NAME__confidence[] = "confidence";

static rosidl_runtime_c__type_description__Field aurora_msgs__msg__Object3D__FIELDS[] = {
  {
    {aurora_msgs__msg__Object3D__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {aurora_msgs__msg__Object3D__FIELD_NAME__id, 2, 2},
    {
  ...
  {
    {aurora_msgs__msg__Object3D__FIELD_NAME__type, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {aurora_msgs__msg__Object3D__FIELD_NAME__size, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {aurora_msgs__msg__Object3D__FIELD_NAME__pose, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {aurora_msgs__msg__Object3D__FIELD_NAME__confidence, 10, 10},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription aurora_msgs__msg__Object3D__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {aurora_msgs__msg__Object3D__FIELDS, 6, 6},
    },
    {aurora_msgs__msg__Object3D__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *aurora_msgs__msg__Object3D__get_individual_type_description_source(NULL),
